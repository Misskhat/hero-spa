...
const TrandingApps = ({data}) => {
    ...
    return (
        <div className="md:w-[1280px] mx-auto my-20 flex flex-col items-center justify-center">
            <div className="text-center my-10">
                <h2 className="font-bold md:text-5xl text-2xl text-[#001931] mb-4">Trending Apps</h2>
            ...
            <Link to={'/apps'} className="btn bg-gradient-to-tr from-[#632EE3] to-[#9F62F2] mt-10 text-white border-[#9F62F2]">Show All</Link>
        </div>
    );
};
